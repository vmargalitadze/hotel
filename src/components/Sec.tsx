          ...
          <div className="grid mt-2 grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <div className="space-y-8">
              <h2 className="  text-[20px] mb-4 md:text-[30px] font-cormorant font-bold md:text-start text-center">
                ადგილი სადაც კომფორტი ბუნების სილამაზეს ხვდება
              </h2>
              <div className="group">
                ...
                <div className="mt-6">
                  <h3 className=" text-[20px] text-center text-black font-cormorant  mb-4">
                    ბუნებაში ჩაფლული ჩვენი კოტეჯები თანამედროვე კომფორტსა და
                    სოფლურ ხიბლს აერთიანებს. გაიღვიძეთ ჩიტების ჭიკჭიკით,
                    ისუნთქეთ სუფთა ჰაერით და იგრძენით თავი განახლებულად
                  </h3>
                </div>
              </div>
            </div>
